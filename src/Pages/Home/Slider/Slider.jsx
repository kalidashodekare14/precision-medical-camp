        ...
        <Carousel showThumbs useKeyboardArrows stopOnHover swipeable dynamicHeight emulateTouch showArrows showStatus infiniteLoop showIndicators>
            <div className='flex flex-col justify-center items-start lg:px-32  banner2 bg-no-repeat bg-center bg-cover h-[80vh] lg:min-h-screen space-y-6'>
                <div className='text-white w-2/3 space-y-3'>
                    <h1 className='lg:text-7xl text-3xl text-cener lg:text-left font-bold'>Inspiring <span className='text-[#29c178]'>Success Stories</span></h1>
                    ...
                    <div className='text-left'>
                        <button className='bg-opacity-0  text-white border-[#29c178] hover:bg-[#29c178] hover:text-black btn'>Learn More</button>
                    </div>
                </div>
            </div>
            ...
            <div className='text-white w-2/3 space-y-3'>
                    <h1 className='lg:text-7xl text-3xl text-cener lg:text-left font-bold'>Sarah's Journey to <span className='text-[#29c178]'>Health</span></h1>
